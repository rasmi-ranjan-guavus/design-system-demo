      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          { className: 'name', onClick: function onClick() {
              return (0, _client2.default)('checkoutBranch', name);
        ...
        (0, _preact.h)(
          ...
          { className: 'delete', onClick: function onClick() {
              return (0, _client2.default)('deleteBranch', name);
            } },
          (0, _preact.h)('img', { src: 'delete.svg', title: 'Delete the branch' })
        )
      );
    }
  }]);
...
var Branches = function (_Component2) {
  _inherits(Branches, _Component2);

  function Branches(props) {
    _classCallCheck(this, Branches);

    var _this2 = _possibleConstructorReturn(this, (Branches.__proto__ || Object.getPrototypeOf(Branches)).call(this, props));
    ...
    value: function render(props, _ref2) {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            { onClick: function onClick() {
                return (0, _client2.default)('createBranch');
              }, className: 'create' },
            'Create a new branch'
          )
        ),
        ...
        (branches || []).map(function (name) {
          return (0, _preact.h)(Branch, { key: name,
            name: name,
...
(0, _preact.render)((0, _preact.h)(Branches, null), document.getElementById('container'));
